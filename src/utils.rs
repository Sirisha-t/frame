...
pub fn print_statistics(
    reads: &ReadSummary,
    assembly_unitigs: usize,
    assembly_coding: usize,
) {
    println!("\n╔════════════════════════════════════════════════════════╗");
    println!("║         FRAME PIPELINE EXECUTION SUMMARY               ║");
    println!("╠════════════════════════════════════════════════════════╣");
    println!("║ Read Processing:                                       ║");
    println!("║   Total reads scanned:        {:>20}    ║", reads.total_reads);
    println!("║   Reads assembled:            {:>20}    ║", reads.reads_assembled);
    println!("║   Reads rescued:              {:>20}    ║", reads.reads_rescued);
    println!("║   Rescue rate:                {:>19.1}%   ║", reads.rescue_rate());
    println!("╠════════════════════════════════════════════════════════╣");
    println!("║ Assembly Results:                                      ║");
    println!("║   Total unitigs:              {:>20}    ║", assembly_unitigs);
    println!("║   Coding unitigs (FGS+):      {:>20}    ║", assembly_coding);
    println!("╚════════════════════════════════════════════════════════╝\n");
}
